        ...
        <div class="portlet light portlet-fit portlet-datatable ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">日转发统计</span>
                </div>
            </div>
            <div class="portlet-body">
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_orders">
                        ...
                        <tr role="row" class="heading">
                            <th width="5%">日期</th>
                            <th width="7%">转发按钮点击次数</th>
                            <th width="7%">转发按钮详情一次</th>
                            <th width="7%">转发按钮详情二次</th>
                            <th width="7%">一次转发量</th>
                            <th width="7%">二次转发量</th>
                            <th width="7%">转发量</th>
                            <th width="7%">一次群阅读量</th>
                            <th width="7%">二次群阅读量</th>
                            <th width="7%">群阅读量</th>
                            <th width="7%">一次个人阅读量</th>
                            <th width="7%">二次个人阅读量</th>
                            <th width="7%">个人阅读量</th>
                            <th width="7%">一次有效转发</th>
                            <th width="7%">二次有效转发</th>
                            <th width="7%">有效转发</th>
                        </tr>
                        </thead>
            ...
            var handleOrders = function () {
                ...
                grid.init({
                    ...
                    dataTable: {
                        ...
                        "ajax": {
                            "url": "/admin/reportZf/datalist", // ajax source
                            "type": "POST",
                            "data": function (d) {
                                d._token = "{{csrf_token()}}";
                        ...
                        'aoColumns':[
                            ...
                            {'mData':'one_click_num'},
                            {'mData':'too_click_num'},
                            {'mData':'one_zf_read_num'},
                            {'mData':'too_zf_read_num'},
                            {'mData':'zf_read_num'},
                            {'mData':'one_group_read'},
                            {'mData':'too_group_read'},
                            {'mData':'group_read'},
                            {'mData':'one_personal_read'},
                            {'mData':'too_personal_read'},
                            {'mData':'personal_read'},
                            {'mData':'one_valid_read'},
                            {'mData':'too_valid_read'},
                            {'mData':'valid_read'}
                        ],
