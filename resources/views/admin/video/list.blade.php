        ...
        <div class="portlet light portlet-fit portlet-datatable ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">视频列表</span>
                </div>
                <div class="actions">
                    <div class="btn-group btn-group-devided" data-toggle="buttons" data-times="0" id="uploadVideo">
                        <label class="btn btn-transparent green btn-outline btn-outline btn-sm active" >
                            <input type="radio" class="toggle" >上传新视频
                        </label>
                    </div>
            ...
            <div class="portlet-body">
                <div class="table-container">
                    <div class="table-actions-wrapper">
                        ...
                        <select class="bs-select form-control" id="cate_id" style="margin-right: 8px;width:118px;float: left">
                            <option value="">分类</option>
                            @foreach($cateInfo as $k=>$val)
                                ...
                                <div class="portlet-body col-md-10">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label"><span style="color: red">*</span>标题:</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="title" placeholder="请输入标题">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label"><span style="color: red">*</span>播放地址:</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="url" placeholder="请输入播放地址">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-4 control-label"><span style="color: red">*</span>封面图:</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="img" placeholder="请输入封面图">
                                            </div>
                                        </div>
    ...
    <script>
            ...
            var handleOrders = function () {
                ...
                grid.init({
                    ...
                    dataTable: {
                        ...
                        "ajax": {
                            "url": "/admin/videoList/datalist", // ajax source
                            "type": "POST",
                            "data": function (d) {
                                d._token = "{{csrf_token()}}";
                        ...
                        'aoColumns':[
                            ...
                            {'mData':function(lineData){
                                var imgurl = lineData.img;
                                var img = ' <img src="'+imgurl+'" alt=""  style="width: 75px;border: 1px solid lightgrey;border-radius:4px;">';
                                return img;
                            }},
                            {'mData':function(lineData){
        ...
        $("#uploadVideo").click(function () {
            if ($(this).data("times") == 0) {
                $(this).next().wrap("<form action='/admin/videoList/upload' method='post' enctype='multipart/form-data'></form>");
                $(this).data("times", 1);
            }
            $(this).next().children(":first-child").click();
        });

//        $(".pic_up").on("click",function(){
//            console.log(2122);
//        })
        ...
        function BindEvent() {
            ...
            if(check){1
                ...
                if(verify(["title","url","img","status"],postData)){
        ...
        function edit(id){
            ...
            $.get('/admin/videoList/edit/'+id,function(data){
                $('#data_form')[0].reset();
                $("#form-title").html("编辑");
        ...
        function del(id){
            swal({
                ...
                //判断是否正在删除
                if(r){
                    $.post("/admin/videoList/delete/"+id,{'_token':"{{csrf_token()}}"}, function (data) {
                        if (data.success) {
                            toastr.success(data.msg, "提示")
                            $("#datatable_orders").DataTable().ajax.reload();
                        }else {
