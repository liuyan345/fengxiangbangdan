...
<div class="content">
    ...
    <form class="register-form" action="/home/channelAdd" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control placeholder-no-fix" type="text" placeholder="北京xx有限责任公司" name="name" /> </div>
        <div class="form-group">
            <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
            <label class="control-label visible-ie8 visible-ie9">联系人</label>
            <input class="form-control placeholder-no-fix" type="text" placeholder="王小姐" name="linkman" /> </div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">联系人电话</label>
            <input class="form-control placeholder-no-fix" type="text" placeholder="135xxxx1124" name="linkmanMobile" /> </div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">联系人qq</label>
            <input class="form-control placeholder-no-fix" type="text" placeholder="123456" name="qq" /> </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control placeholder-no-fix" type="text" placeholder="北京" name="area" /> </div>
        <div class="form-group">
